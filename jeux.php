    ...
    <section id="game-jumbotron pt-5">
        <div class="container pt-5 md-5">
            ...
            <p>Nous avons mis à votre disposition 4 consoles de jeux de différentes époques pour que vous découvriez le
                ...
                console) qui est sortie en premier en Chine en 1994.
                La super Nitendo à sa sortie en Europe en 1992, la console Super Nintendo Entertainment époustoufla les joueurs avec ses graphismes et sa jouabilité qui propulsaient le monde des jeux vidéo dans une ère spectaculairement nouvelle.
                La Xbox sorite par microsoft en 2001 avec les différents jeux développé par Microsoft game. Pour la
                dernière console que nous avons dans le bar est l'extraordinaire Magnavox qui est la toute première
                génération de console apparu en 1972. </p>

                    <div class="card-deck">
                        <div class="card npcard">
                            <img class="card-img-top" src="public/images/jeux/console.png" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card npcard">
                            <img class="card-img-top" src="public/images/jeux/premiereconsole.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Magnavox</h5>
    ...
    <section id="gameboy-jumbotron">
        <div class="container">
            ...
            <p>Pour les fadas d'anciennes gameboy, vous pourrez y jouer sur 4 modèles et d'années différentes: Elle est la première console portable de la gamme des Game Boy. Descendante
                ...
                format plus compact et d'améliorations telles qu'un écran rétro-éclairé, ainsi qu'une batterie lithium-ion rechargeable.
                Enfin, en 2005, Nintendo sort la Game Boy Micro, dernière déclinaison de sa portable, une console au format « mini » qui propose écran amélioré.</p>

            <div class="card-deck">
                <div class="card npcard">
                    <img class="card-img-top" src="public/images/jeux/console3.png" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Game Boy Advance</h5>
                        <p class="card-text">une console de jeux vidéo portable créée par Nintendo en 2001. Elle dispose d'un écran couleur et d'un processeur 32 bits, ce qui en faisait à sa sortie la console portable la plus performante.</p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Gameboy Advance </small>
                    </div>
                </div>
                <div class="card npcard">
                    <img class="card-img-top" src="public/images/jeux/game.png" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Game Boy</h5>
                        <p class="card-text">une console portable de jeu vidéo 8-bits de quatrième génération développée et fabriquée par Nintendo.</p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Gameboy</small>
                    </div>
                </div>
                <div class="card npcard">
                    <img class="card-img-top" src="public/images/jeux/gameboy.png" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Advance SP</h5>
                        <p class="card-text"> une console de jeux vidéo portable lancée par Nintendo en mars 2003. Cette console possède les mêmes caractéristiques techniques que la Game Boy Advance mais dispose d'un nouveau design et intègre plusieurs changements.</p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Gameboy</small>
                    </div>
